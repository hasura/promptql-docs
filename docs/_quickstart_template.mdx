...
```ddn title="Before you can create a new PromptQL DDN project, you need to authenticate your CLI:"
ddn auth login
```
...
```ddn title="Start your local PromptQL DDN engine and PostgreSQL connector:"
