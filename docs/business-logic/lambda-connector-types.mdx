...
Lambda connectors can be written in TypeScript, Python, or Go and can accept and return types in those languages which
map to types in the NDC data model which powers PromptQL.
