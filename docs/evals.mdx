...
<Thumbnail src="/img/evals/eval-3.png" alt="Running an eval item in the console." />

### Step 3. Review the Results

Once the eval run is initiated, you can view the progress and results in the table. Once the eval runs are completed
successfully, you should see a thread created for each eval item run. You can click on the thread to view the
conversation and the results of the eval item prompt.

<Thumbnail src="/img/evals/eval-4.png" alt="Eval results in the console." />

### Step 4. Scoring the eval runs

You can score the eval runs based on how well the agent performed against the eval criteria. You can also add comments
to explain your score.

<Thumbnail src="/img/evals/eval-5.png" alt="Scoring eval runs in the console." />
