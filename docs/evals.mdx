...
2. You should be able to see the list of eval items in the table once it's added.

<Thumbnail src="/img/evals/eval-2.png" alt="List of eval items in the console table." />
<br />

**Coming Soon**: We will have the functionality to run these evals in batches and view the results, and then a human
evaluator can judge the response.
