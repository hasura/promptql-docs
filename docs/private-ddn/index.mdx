...
description:
  "Get started with Hasura Private DDN to build secure, scalable, and customizable AI applications on your own
...
To enable Private DDN, you'll need an Enterprise contract. Reach out to sales [here](https://promptql.io/book-demo).
