...
sidebar_label: JWT
description:
  "Explore how PromptQL DDN supports JWT authentication for your GraphQL API, including setup, configuration, and
...
In JWT mode, session variables are passed to the DDN engine on each request in JSON Web Tokens (JWTs).
