...
This section describes the JSON Web Token (JWT) configuration options available for PromptQL.
...
PromptQL does not currently support rotating JWKs.
...
Clerk integrates with PromptQL using JWTs.
