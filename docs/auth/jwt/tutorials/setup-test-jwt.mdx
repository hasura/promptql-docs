...
By default, your supergraph uses your PromptQL cloud authentication token, also known as a personal access token (PAT),
...
For more information about the claims PromptQL DDN expects, check out [this page](/auth/jwt/jwt-configuration.mdx).
