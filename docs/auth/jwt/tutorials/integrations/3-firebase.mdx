...
description: "Learn how to connect Firebase to your PromptQL application."
keywords:
  - hasura
  - promptql
  - authentication
...
generate a JWT which you can pass in the header of your requests to the DDN engine. After setting up your
...
In this guide, you learned how to integrate Firebase with DDN and PromptQL to create a secure and scalable identity
