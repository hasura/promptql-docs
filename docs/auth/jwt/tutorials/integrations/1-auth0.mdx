...
sidebar_position: 2
sidebar_label: Auth0
description: "Learn how to connect Auth0 to your PromptQL DDN supergraph."
keywords:
  - hasura
  - hasura ddn
  - authentication
...
underlying data served by the DDN engine to PromptQL.
...
Enter a name for your Action such as `PromptQL JWT Claims` and paste the following code:
...
In this guide, you learned how to integrate Auth0 with DDN and PromptQL to create a secure and scalable identity
