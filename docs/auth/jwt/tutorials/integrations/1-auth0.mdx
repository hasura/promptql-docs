...
which you can pass in the header of your requests to PromptQL. After setting up your
...
definition:
  mode:
    jwt:
      ...
      audience: ["<your PromptQL endpoint>"]
      tokenLocation:
        type: Header
        name: Auth-Token
```
...
value as a header in the PromptQL Playground and test any permissions you have in your metadata. If you're unfamiliar
with this, we have a sample repo [here](https://github.com/hasura/ddn-auth-examples/tree/main/auth0).
...
In this guide, you learned how to integrate Auth0 with PromptQL to create a secure and scalable identity management
