...
value as a header in [PiQL](/auth/piql-auth.mdx) and test any permissions you have in your metadata. If you're
unfamiliar with this, we have a sample repo [here](https://github.com/hasura/ddn-auth-examples/tree/main/auth0).
