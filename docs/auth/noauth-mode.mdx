...
NoAuth mode is a simple way to run your PromptQL instance without authentication. This is useful for testing or
development purposes or to run your PromptQL project as fully public without any authentication.
...
The role to be assumed while running the application in `noAuth` mode. If you intend for your production API to be fully
