...
NoAuth mode is a simple way to run your project without authentication and is enabled by default. This is useful for
...
```title="Open the PromptQL console and make a query:"
ddn console --local
```
