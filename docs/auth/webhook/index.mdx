...
description:
  ...
  Understand the process and requirements, and how to control the Hasura's response to user authentication."
keywords:
  - hasura webhook mode
...
You can configure PromptQL to use webhook mode in order to authenticate incoming requests.
