...
More information can be found in the metadata docs for [TypePermissions](reference/metadata-reference/permissions.mdx#typepermissions-typepermissions-(v2))
...
More information can be found in the metadata docs for [ModelPermissions](reference/metadata-reference/permissions.mdx#modelpermissions-modelpermissions-(v2))
...
More information can be found in the metadata docs for [CommandPermissions](reference/metadata-reference/permissions.mdx#commandpermissions-commandpermissions-(v2))
