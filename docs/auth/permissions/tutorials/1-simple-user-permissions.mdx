...
This can be done by passing a value in the header of each request to your application; the DDN engine will then use that
value to return only the data which matches conditions you specify.
...
- [Permissions](/auth/permissions/index.mdx) with DDN
- [Auth](/auth/overview.mdx) with DDN
