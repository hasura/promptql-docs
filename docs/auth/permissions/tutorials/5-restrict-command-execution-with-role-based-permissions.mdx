...
[tutorial found in our PostgreSQL getting-started section](/how-to-build-with-promptql/with-postgresql.mdx) and
**restrict users to only being able to update posts of which they're the author**.
