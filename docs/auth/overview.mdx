...
Hasura DDN is agnostic about how you authenticate users. You can integrate many popular auth services or use your own
custom solution.

After authentication, session variables are passed via either a valid JWT or webhook to the Hasura Engine to be checked
against your access control rules or "permissions" to determine what data the PromptQL user can access. This ensures any
