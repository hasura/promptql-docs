...
- **Models → General**
  - **Description** - Clarify the model's purpose and usage to improve PromptQL's contextual understanding.
  - **Signature** - Discuss function signatures, return types, and argument structures for optimal query planning.
...
aligned on data structure and permissions, leading to more accurate and insightful PromptQL conversations.
