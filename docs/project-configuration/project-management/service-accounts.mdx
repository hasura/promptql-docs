...
:::tip Streamline CI/CD workflows For more efficient automation with service accounts, you can create and apply the
supergraph build in a single command using `ddn supergraph build create [flags] --apply` :::
