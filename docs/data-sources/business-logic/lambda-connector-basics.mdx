...
You can use lambda connectors in conjunction with connectors to conventional data sources to allow PromptQL to run
custom business logic on behalf of a user.
