...
You can use lambda connectors to give PromptQL the ability to execute custom business logic on behalf of the user.

Using Hasura DDN, we can add a Lamdba connector runtime in Node.js with TypeScript, Python, or Go.
