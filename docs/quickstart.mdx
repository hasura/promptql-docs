...
description:
  "Learn how to get started with PromptQL by asking complex questions, building automations, and assessing the accuracy
  of your agent."
keywords:
  - promptql
  - quickstart
...
[collection of sandboxes](/index.mdx#sandboxes) which allow you to try PromptQL and get a feel for the experience.
Below, we'll use the `sandbox-gtm` example.
