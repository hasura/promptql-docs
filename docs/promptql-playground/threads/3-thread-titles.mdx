...
description: "Learn about thread title functionality in the PromptQL Playground - automatic generation and manual editing"
keywords:
  - hasura
  - promptql
  - threads
...
Thread titles in the PromptQL Playground help you organize and identify your conversations with data. The system provides both automatic title generation and manual editing capabilities to ensure your threads are properly labeled and easy to find.
...
You can manually edit any thread title directly from the thread history sidebar. Look for the edit icon (pencil) next to the thread title.
