...
the logic of lambda connectors, you can [enable Compose Watch](/data-sources/business-logic/dev-mode.mdx) to reflect
your changes instantly and rebuild your lambda connector's container.
