...
After you've created a metadata to use with PromptQL, you'll often need to iterate on your data model — whether you're
adding a new table, refining a command, or evolving your business logic.
...
build of your application. This will ensure the JSON configuration files consumed by the engine are updated with the
latest changes.
...
:::info Build for PromptQL Cloud

You can also build a new supergraph for a project on PromptQL Cloud:

If you don't have a project on PromptQL Cloud, you can create one by running:
