...
In DDN, commands represent operations that can be executed such as those which modify data in your data sources,
(inserts, updates, deletes), or that perform complex read operations or execute custom business logic.
