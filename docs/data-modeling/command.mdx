...
[How to Build with DDN](/how-to-build-with-promptql/overview.mdx) section. Select the relevant data connector to follow
the tutorial.

### Creating a command

To enable PromptQL to modify your data, you first need to create commands that map to specific operations within your
data sources.
...
Lambda connectors allow PromptQL to execute custom business logic as part of its query plan. You can learn more about
Lambda connectors in the [docs](/business-logic/overview.mdx).

:::

### Updating a command

Your underlying data source may change over time. You can update your commands to ensure PromptQL continues to interact
accurately with your data.
