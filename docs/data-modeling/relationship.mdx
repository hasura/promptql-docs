...
```ddn title="Run the following command in your DDN project directory:"
...
```ddn title="Create a build of your supergraph API:"
ddn supergraph build local
```

```ddn title="Serve your build as your API locally:"
