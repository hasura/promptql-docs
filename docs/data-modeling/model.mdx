---
sidebar_position: 2
sidebar_label: "Models enable PromptQL to understand your data"
...
[How to Build with PromptQL](/how-to-build-with-promptql/overview.mdx) section. Select the relevant data connector to
follow the tutorial.

### Creating a model

To enable PromptQL to understand and interact with your data, you'll first need to create models that represent that
data.
...
Your underlying data source may change over time. You can update your model to reflect these changes and ensure PromptQL
continues to have accurate understanding of your data.
