...
<div className={'front-matter'}>
  <div>
    Hasura DDN streamlines the development and operation of modern federated data APIs, <Link to="/how-to-build-with-promptql/overview/">solving key challenges</Link> in the process.
