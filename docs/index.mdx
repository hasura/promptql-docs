...
description:
  ...
  accuracy, and repeatability for complex tasks. Learn how PromptQL leverages PromptQL DDN's connectors to help you
...
<div className={'front-matter'}>
  <div>
    ...
    PromptQL's data layer (PromptQL DDN) comes with out of the box connectors to a wide range of data sources. These
