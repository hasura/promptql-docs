...
For automation management operations, you need to obtain a JWT token using your Personal Access Token (PAT) or Project
Service Account Token. See the
[Authentication Guide](/promptql-apis/auth.mdx#getting-jwt-tokens-for-user-scoped-operations) for detailed instructions
on how to get JWT tokens.
