...
The timezone setting for schedules does not currently have any effect - all schedules run according to UTC time. This is
planned to change in the near future.
