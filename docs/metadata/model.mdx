...
import ModelCreateNativeQueryHowToPostgreSQL from "@site/docs/metadata/partials/classic-connectors/postgreSQL/_model-create-native-query-how-to.mdx";
...
The way this is done is via a `Relationship`. Read more about [creating relationships here](/metadata/relationship.mdx).
