...
If you don't have an existing PostgreSQL database, you can leave this blank to use the included PostgreSQL docker
compose file which will spin up a PostgreSQL database and a postgres-adminer instance you can use to seed with some data
...
Take a look at our [PostgreSQL docs](/reference/connectors/postgresql/index.mdx) to learn more about how to use PromptQL
with PostgreSQL. Or, if you're ready, get started with [adding custom business logic](/business-logic/overview.mdx) to
get PromptQL to act on a user's behalf!
