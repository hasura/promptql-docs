...
```sh title="Next, use the CLI to introspect your source:"
ddn connector introspect my_connector
```

After running this, you should see a representation of your source's schema in the
`app/connector/my_connector/configuration.json` file; you can view this using `cat` or open the file in your editor.
...
```sh title="Add your resources to create metadata:"
...
```sh title="Start your local Hasura DDN Engine and connector:"
