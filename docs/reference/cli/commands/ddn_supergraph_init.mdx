...
ddn supergraph init <path-to-project-dir> [flags] --project-data-plane-id <your-data-plane-id>
```
...
# If you don't have a data plane provisioned, please contact your AI strategist
 ddn supergraph init <path-to-project-dir> --project-data-plane-id <your-data-plane-id>

# Initialize a new Supergraph project directory with a subgraph 'mysg'
# If you don't have a data plane provisioned, please contact your AI strategist
 ddn supergraph init <path-to-project-dir> --create-subgraph mysg --project-data-plane-id <your-data-plane-id>
```
