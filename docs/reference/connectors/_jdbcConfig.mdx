...
application. This is useful if there's a custom function, stored procedure, or complex query that you want to leverage
directly in your application.

### Add a new native operation

TODO: Brandon Martin

- On specific pages where this component is imported, you can then add source-specific caveats below.
