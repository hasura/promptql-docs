...
The SQL structure of a Native Query is specified in the
[Native Operation syntax](/reference/connectors/nativeQuerySyntax.mdx) page.
...
3. Create a new entry in the connector configuration:
   ...
   NOTE: The `operation-path` provided should be relative to the configuration directory. It means that for the below
