...
To explore this file, [try out the how-to guide for Prometheus](/how-to-build-with-promptql/with-prometheus.mdx) and —
after introspecting — grep through the generated HML file for any metrics or API endpoints you desire.
