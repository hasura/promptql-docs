...
Native Queries allow you to run custom SQL queries on your BigQuery database. These allow you to run queries that are not supported by PromptQL by default.
