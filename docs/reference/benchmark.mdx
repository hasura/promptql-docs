...
<Thumbnail src="/img/get-started/challenge-2.png" alt="A PromptQL agent chat instance" className="thumbnail-small" />

<Thumbnail src="/img/get-started/failure2-computation-in-context.png" alt="A PromptQL agent chat instance" />
