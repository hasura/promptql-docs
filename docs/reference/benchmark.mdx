...
- **Computational accuracy**: The correctness of the result on a task that can be solved programmatically
...
A user-assigned score between 0 and 1 indicating how accurately the system handles computational (algorithmic) tasks.
