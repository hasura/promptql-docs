...
Commands also allow you to execute [custom business logic](/data-sources/business-logic/index.mdx) directly from your
...
As an example, if you're usings the [TypesScript connector](/data-sources/business-logic/index.mdx) for business
