...
description: "Configure the authentication configuration used by the distributed query engine."
...
access to your API and make use of Hasura's powerful [authorization](/auth/index.mdx) features. The metadata examples
...
| `alternativeModes` | array / null | false |  |
