...
| Key | Value | Required | Description |
|-----|-----|-----|-----|
| `harassment` | [undefined](#promptqlconfigv2-undefined) / null | false | Negative or harmful comments targeting identity and/or protected attributes. |
| `hateSpeech` | [undefined](#promptqlconfigv2-undefined) / null | false | Content that is rude, disrespectful, or profane. |
| `sexuallyExplicit` | [undefined](#promptqlconfigv2-undefined) / null | false | Contains references to sexual acts or other lewd content. |
| `dangerous` | [undefined](#promptqlconfigv2-undefined) / null | false | Promotes, facilitates, or encourages harmful acts. |
| `civicIntegrity` | [undefined](#promptqlconfigv2-undefined) / null | false | Election-related queries. |
