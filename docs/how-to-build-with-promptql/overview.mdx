...
- [With a persistent datasource and custom business logic](/recipes/with-a-datasource-and-custom-business-logic.mdx)
- [With API endpoints](/recipes/with-api-endpoints.mdx)
- [With bulk API data](/recipes/with-apis-with-bulk-data.mdx)
