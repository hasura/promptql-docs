...
To deploy your application and make it accessible to the world you will create builds of your connectors, subgraphs, and
the supergraph. This can all be done in a single command. You will then apply the supergraph build to your project,
making it the "official" build for the project.

PromptQL will use this to answer queries by accessing data according to the structure of the build.
