...
```ddn title="If you haven't yet done this, create a new context using the CLI:"
...
```ddn title="Using the deployment context, use the DDN CLI to create your project's metadata:"
